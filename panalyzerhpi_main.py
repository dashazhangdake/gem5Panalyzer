...
from utility.avf_calculator_packed import avf_calculator_packed_lite_hpi
...
def Phy_AVF_inorder(trace_ut):
    ...
    trace_file_name = trace_ut + '_inorder'
    ...
    '''
    num_reg = 16  # Number of the Int Physical Registers in the simulated gem5 system
    ...
    while start_line < end_line:
        ...
        with concurrent.futures.ProcessPoolExecutor() as executor:
            results_this_thread = [executor.submit(avf_calculator_packed_lite_hpi, trace_file,
